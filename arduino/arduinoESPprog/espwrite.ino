// Copyright (C) 2014 SISTEMAS O.R.P. 
 ...
 # define  SEARCH_AFTER _ RESET  "ready" 
 # define  INTRO   "\r\n" 
 
 # define  AP _ NORMAL  "SISTEMASORP" 
 # define  PWD _ NORMAL  "mypassword" 
 # define  HOST _ NORMAL  "192.168.1.33" 
 # define  PORT _ NORMAL  "49000" 
 
 # define  AP _ BOOTLOADER  "SISTEMASORP" 
 # define  PWD _ BOOTLOADER  "mypassword" 
 # define  HOST _ BOOTLOADER  "192.168.1.33" 
 # define  PORT _ BOOTLOADER  "50000" 
